 ...
 */
class PswirepaymentmultiPaymentModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $total = sprintf(
            $this->getTranslator()->trans('%1$s (tax incl.)', [], 'Modules.Wirepaymentmulti.Shop'),
        ...
        $this->context->smarty->assign([
            ...
            'confirm_url' => $this->context->link->getModuleLink('pswirepaymentmulti', 'validation', [], true),
